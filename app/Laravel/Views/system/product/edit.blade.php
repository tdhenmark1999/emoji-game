        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel panel-default panel-border-color panel-border-color-success">
                    <div class="panel-heading panel-heading-divider">Update Record Form<span class="panel-subtitle">Areas
                    ...
                    <div class="panel-body">
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 text-center">
                                <img id="blah_primary_back" src="{{ asset('uploads/images/' . $category->file_name) }}"
                            ...
                            <div class="form-group {{ $errors->first('category') ? 'has-error' : null }}">
                                ...
                                <select class="form-control" name="category">
                                    ...
                                    @foreach ($categories as $categoryData)
                                        <option selected="{{ $category->category }}" value="{{ $categoryData->name }}">
                            ...
                            <div class="row xs-pt-15">
                                <div class="col-xs-6">
                                    ...
                                    <a href="{{ route('system.product.index') }}"
